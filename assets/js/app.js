...
const btnAgregarHeroe = document.querySelector("#btnAgregarHeroe");
const nombreHeroe = document.querySelector("#nombreHeroe");
const urlHeroe = document.querySelector("#urlHeroe");
